            ...
            <form class=" formule" action="update.php?id=<? echo $row['id']; ?>" method="POST">
                <div class="parent section affiche">
                    ...
                    <div class="parent__children">
                        ...
                        <input class="parent__input" type="date" name="date_embauche" placeholder="Entrer date embauche " value="<?php echo isset($row['date_embauche']) ? $row['date_embauche'] : ''; ?>"><br><br>
                    </div>
                    <div class="parent__children">
                        <label class="parent__label" for="date embauche">Service*</label><br>
                        <select style="width: 19%;margin-bottom: 21px;" class="parent__input" name="Service">
                            <?php
